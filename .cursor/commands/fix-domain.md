...
AAAC: `/fix-domain <domain> "<intent>"`

**Layer:** system  
**Repair something broken** a **domain** — Bounded context / product domain.

## Dispatch

1. [.cursor/aaac/dispatch.md](../aaac/dispatch.md)
2. [.cursor/aaac/graph.yaml](../aaac/graph.yaml) — **`fix-domain`**
3. [skills/shared/verbs/fix/orchestrator/SKILL.md](../skills/shared/verbs/fix/orchestrator/SKILL.md) (object: `domain`)
